    ...
    >
      ...
      <aside className="w-[220px] flex-shrink-0 bg-white border-r border-gray-100 flex flex-col h-full">
        ...
        <div className="px-4 h-14 flex items-center gap-2.5 border-b border-gray-100">
          ...
          <span className="text-sm font-semibold text-gray-900 truncate">Acme Corp</span>
          <ChevronDownIcon className="w-3.5 h-3.5 text-gray-400 ml-auto flex-shrink-0" />
        </div>
        ...
        <nav className="flex-1 px-2 pt-3 space-y-0.5 overflow-y-auto">
          ...
          <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-sm text-gray-500 hover:text-gray-800 hover:bg-gray-50">
            <SettingsIcon className="w-4 h-4 flex-shrink-0 text-gray-400" />
            Settings
          </button>
          <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-sm text-gray-500 hover:text-gray-800 hover:bg-gray-50">
            <HelpCircleIcon className="w-4 h-4 flex-shrink-0 text-gray-400" />
            Help
          </button>
        </nav>
        ...
        <div className="px-3 py-3 border-t border-gray-100 flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-full bg-indigo-600 flex items-center justify-center text-[11px] font-bold text-white flex-shrink-0">SC</div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-gray-800 truncate">Sarah Chen</p>
            <p className="text-[10px] text-gray-400 truncate">HR Lead</p>
          </div>
          <LogOutIcon className="w-3.5 h-3.5 text-gray-300 hover:text-gray-500 flex-shrink-0 cursor-pointer" />
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-gray-100 px-6 flex items-center gap-4 flex-shrink-0">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <div className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-[11px] font-bold text-white cursor-pointer">SC</div>
          </div>
        </header>
              ...
              <div className="space-y-2.5">
                {APPLICANTS.map(({ name, role, stage, stageColor, initials, avatarBg, time }) => (
                  <div key={name} className="flex items-center gap-2.5 group cursor-pointer">
                    <div className={`w-7 h-7 rounded-full ${avatarBg} flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0`}>{initials}</div>
                    <div className="flex-1 min-w-0">
