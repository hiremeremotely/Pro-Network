              ...
              <Card className="rounded-xl border border-gray-200 shadow-none bg-white overflow-hidden">
                <CardContent className="px-3 py-3 space-y-0">
                  ...
                  <div className="pt-2.5 flex items-center justify-between">
                    ...
                    <Link href="/jobs" onClick={() => setSidebarOpen(false)} className="text-xs text-primary font-semibold hover:underline">
                      Browse roles →
                    </Link>
                  </div>
                </CardContent>
            ...
            <Card className="rounded-xl border border-gray-200 shadow-none bg-white overflow-hidden">
              <CardContent className="px-3 py-3 space-y-0">
                ...
                <div className="pt-2.5 flex items-center justify-between">
                  ...
                  <Link href="/jobs" className="text-xs text-primary font-semibold hover:underline">
                    Browse roles →
                  </Link>
                </div>
              </CardContent>
